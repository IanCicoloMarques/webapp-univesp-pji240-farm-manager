...
export default function NextDeliveryPage(){
    ...
    useEffect(() => {
        ...
        const request = axios.post(`${process.env.REACT_APP_BACKEND_URI}/orders/GetOrderByDate?date=${requestDate}`);
    ...
    return (
        ...
        <div>
            <div>
                <DatePicker selected={date} onChange={(updatedDate) => updateDate(updatedDate)} />
            </div>
            <div>
